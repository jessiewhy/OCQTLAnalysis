...
```{r}
me.fit <- lm(GC.tumor ~ D1MIT215+D2MIT145+D4MIT232+D13MIT292, data=data)
summary(me.fit)
```
## Interaction
```{r}
full.fit <- lm(GC.tumor ~ D1MIT215+D2MIT145+D4MIT232+D13MIT292+D10MIT80+D17MIT197+D18MIT12+
                   D2MIT145*D10MIT80+D17MIT197*D18MIT12, data=data)
summary(full.fit)
```
